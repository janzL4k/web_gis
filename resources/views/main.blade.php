            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="show-cat-btn" href="#" id="nav-menu">
                            ...
                            <ul class="cat-sub-menu" for="nav-menu">
                                <li>
                                    <a href="{{ route('gunung.index') }}">Lokasi</a>
                                </li>
                                <li>
                                    <a href="media-02.html">Ketinggian</a>
                                </li>
                            </ul>
                        </li>
                        <li>
...
// add to map
L.marker([-8.5956624,116.1161152], {icon: hospital}).addTo(map);
